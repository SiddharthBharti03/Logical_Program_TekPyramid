...
public class StudentManagementSystem {
    public static void main(String[] args) {
        ...
        while(true){
            ...
            System.out.println("Enter 3 for Search for Student Email :");
            ...
            switch (choice){
                ...
                case 3 :
                    try {
                        ...
                        Student allStudents = st.getStudentByEmail(email);
                ...
                case 4 :
                    try{
                        ...
                        System.out.println("Enter your Email : ");
                        String email=scanner.nextLine();
                        Student updateStudents=st.updateStudent(email);
